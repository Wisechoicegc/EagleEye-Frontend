      ...
      <div className="mb-10 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="p-4 md:p-6 xl:p-9">
          ...
          <div className="mb-7.5 flex flex-wrap gap-5 xl:gap-7.5">
            <Link
              to="#"
              className="inline-flex items-center justify-center gap-2.5 border border-meta-3 py-4 px-10 text-center font-medium text-meta-3 hover:bg-opacity-90 lg:px-8 xl:px-10"
            >
              <span>
                <svg
                  className="fill-current"
            ...
            <Link
              to="#"
              className="inline-flex items-center justify-center gap-2.5 border border-black py-4 px-10 text-center font-medium text-black hover:bg-opacity-90 lg:px-8 xl:px-10"
            >
              <span>
                <svg
                  className="fill-current"
